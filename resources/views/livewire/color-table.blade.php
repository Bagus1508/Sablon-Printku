                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                <button wire:click="editWarna({{$item->id}})" data-hs-overlay="#modal-edit-warna" type="button"
                                ...
                                <button wire:click="deleteWarna({{$item->id}})"data-hs-overlay="#modal-delete-warna" type="button"
