                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                <button wire:click="editKategori({{$item->id}})" data-hs-overlay="#modal-edit-kategori" type="button"
                                ...
                                <button wire:click="deleteKategori({{$item->id}})" data-hs-overlay="#modal-delete-kategori" type="button"
