                ...
                @foreach ($data as $item)                    
                    <tr>
                        ...
                        <td class="text-center whitespace-nowrap border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <p class="text-black dark:text-white">{{$item->no_surat_jalan ?? '-'}}</p>
                        </td>
                        <td class="text-center whitespace-nowrap border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <p class="text-black dark:text-white">{{$item->permintaanBarang->nama ?? '-'}}</p>
                        </td>
                        <td class="text-center whitespace-nowrap border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                            <p class="text-black dark:text-white">{{ getDeliveryStatusList($item->status ?? 0) }}</p>
                        </td>
                        <td class="text-center whitespace-nowrap border-b border-[#eee] px-4 py-5 dark:border-strokedark">
