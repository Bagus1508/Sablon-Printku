<div>
    ...
    {{$dataStok->links()}}
    @include('pages.dashboard.monitoring_persediaan.pakaian_celana.satuan.stok.edit')
    @include('pages.dashboard.monitoring_persediaan.pakaian_celana.satuan.stok.delete')
</div>