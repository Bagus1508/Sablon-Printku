                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                <button wire:click="editUkuran({{$item->id}})" data-hs-overlay="#modal-edit-ukuran" type="button"
                                ...
                                <button wire:click="deleteUkuran({{$item->id}})" data-hs-overlay="#modal-delete-ukuran" type="button"
