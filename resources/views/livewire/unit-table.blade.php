                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                <button wire:click="editSatuan({{$item->id}})" data-hs-overlay="#modal-edit-satuan" type="button"
                                ...
                                <button wire:click="deleteSatuan({{$item->id}})" data-hs-overlay="#modal-delete-satuan" type="button"
