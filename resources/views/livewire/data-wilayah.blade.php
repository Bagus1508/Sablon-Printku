<div>
    <div class="mb-4.5 w-full">
        ...
        <select class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"wire:change='getRegencies' wire:model="provinsi" name="provinsi" id="provinsi" class="input-form-edit">
    ...
    <div wire:loading.remove wire:target='getRegencies' class="mb-4.5 w-full">
        ...
        <select class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"wire:change='getDistricts' wire:model="kota" name="kota" id="kota" class="input-form-edit">
    ...
    <div wire:loading.remove wire:target='getDistricts' class="mb-4.5 w-full">
        ...
        <select class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary"wire:change='getVillages' wire:model="kecamatan" name="kecamatan" id="kecamatan" class="input-form-edit">
    ...
    <div wire:loading.remove wire:target='getVillages' class="mb-4.5 w-full">
        ...
        <select class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" wire:model="kelurahan" name="kelurahan" id="kelurahan" class="input-form-edit">
