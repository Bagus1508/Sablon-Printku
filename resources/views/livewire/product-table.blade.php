<div>
                ...
                <tr>
                    ...
                    <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                        <div class="flex items-center mx-auto justify-center">
                            <button {{-- wire:click="editHakCuti" --}} data-hs-overlay="#modal-edit-produk" type="button"
                            ...
                            <button data-hs-overlay="#modal-delete-produk" type="button"
    ...
    @include('pages.dashboard.produk.create')
    @include('pages.dashboard.produk.edit')
    @include('pages.dashboard.produk.delete')
</div>