<div>
    <section class="justify-between flex max-sm:flex-col-reverse max-sm:mb-5">
        ...
        <div class="my-5">
            <a href="{{ route('permintaan-barang.create') }}" class="bg-blue-600 text-white font-medium px-4 py-2 rounded-md hover:bg-blue-700">+ Tambah Data</a>
        </div>
    </section>
                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                <a href="{{ route('permintaan-barang.edit', $item->id) }}" id="edit-permintaan-barang"
