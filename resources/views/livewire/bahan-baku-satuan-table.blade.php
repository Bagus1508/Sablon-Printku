                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                ...
                                <button wire:click="editBahanBaku({{$item->id}})" title="Edit Data" data-hs-overlay="#modal-edit-produk" type="button"
                                ...
                                <button wire:click="deleteBahanBaku({{$item->id}})" title="Hapus Data" data-hs-overlay="#modal-delete-produk" type="button"
