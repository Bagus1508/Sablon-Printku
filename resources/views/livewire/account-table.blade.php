                    ...
                    <tr>
                        ...
                        <td class="mx-auto px-4 py-5 border-b border-[#eee] dark:border-strokedark">
                            <div class="flex items-center mx-auto justify-center">
                                <button wire:click="editUser({{ $item->id }})" data-hs-overlay="#modal-edit-akun" type="button"
                                ...
                                <button wire:click="deleteUser({{$item->id}})" data-hs-overlay="#modal-delete-akun" type="button"
