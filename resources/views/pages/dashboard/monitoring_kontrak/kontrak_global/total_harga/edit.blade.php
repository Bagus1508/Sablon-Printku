    ...
    <div
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form method="POST" action="{{route('monitoring-kontrak-global.updateTotalHarga', (int)$ID)}}" id="form-edit-total-harga">
                    @csrf
                    <div class="p-6.5">
...
<script>
    ...
    const url = '{{ route("monitoring-kontrak-global.updateTotalHarga", ":id") }}'.replace(':id', id);
