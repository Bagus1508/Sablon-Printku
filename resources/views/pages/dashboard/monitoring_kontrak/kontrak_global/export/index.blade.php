<x-app-layout>
    @section('title', 'Monitoring Kontrak Global Export')
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-title-md2 font-bold text-black dark:text-white">
                Monitoring Kontrak Global Export
            </h2>
        </div>
        <div>
            <div class="my-5">
                ...
                <a href="{{route('export-monitoring-kontrak-global', ['tanggal' => $tgl_stok_global])}}">
            ...
            <div class="max-w-full overflow-x-auto rounded-t-md">
                @include('pages.dashboard.monitoring_kontrak.kontrak_global.export.preview')
            </div>
