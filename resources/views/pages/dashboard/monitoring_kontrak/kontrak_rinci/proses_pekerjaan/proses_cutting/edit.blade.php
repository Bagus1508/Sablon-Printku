<div wire:ignore.self id="modal-edit-proses-cutting"
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div
                    ...
                    <div>
                        <button data-hs-overlay="#modal-edit-proses-cutting" type="button"
                ...
                <form method="POST" action="{{route('monitoring-kontrak-rinci.updateProsesCutting', (int)$ID)}}" id="form-proses-cutting">
                    @csrf
                    <div class="p-6.5">
                        <input type="text" hidden name="id" id="proses-cutting-id">
                        <div class="mb-4.5 w-full">
                            <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                                Tanggal Masuk
                            </label>
                            <input type="date" id="tanggal_masuk" name="tanggal_masuk" placeholder="Masukan Tanggal Masuk"
                        ...
                        <div class="mb-4.5 w-full">
                            ...
                            <input type="date" id="tanggal_selesai" name="tanggal_selesai" placeholder="Masukan Tanggal Selesai"
                                class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                        </div>
                    </div>
...
<script>
    ...
    $('.proses-cutting').click(function() {
    const id = $(this).data('id-proses-cutting');
    const tanggal_masuk = $(this).data('tanggal-masuk');
    const tanggal_selesai = $(this).data('tanggal-selesai');
    
    // Mengatur nilai input ID pada form modal
    $('#proses-cutting-id').val(id);
