    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-title-md2 font-bold text-black dark:text-white">
                Data Detail Kontrak Rinci Export
            </h2>
        </div>
        <div>
            <div class="my-5">
                <a href="{{route('export-monitoring-kontrak-rinci-detail', ['id_kontrak_rinci' => $idKontrakRinci, 'checkbox_cutting' => $checkbox_cutting, 'checkbox_jahit' => $checkbox_jahit, 'checkbox_packing' => $checkbox_packing,])}}">
            ...
            <div class="max-w-full overflow-x-auto rounded-t-md">
                @include('pages.dashboard.monitoring_kontrak.kontrak_rinci.export.detail.preview')
            </div>
