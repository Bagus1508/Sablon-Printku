    ...
    <tbody class="dark:bg-meta-4">
        @foreach ($dataKontrakRinci as $data)
            ...
            <tr>
                ...
                <img src="{{ url('storage/upload/dokumen_pengiriman_barang/' . $data->pengirimanBarang->bukti_foto) }}" alt="Bukti Foto" width="200px">
                ...
                <td rowspan="{{ $totalBarang }}" style="text-align: center; white-space: nowrap; text: black; border:1px solid black; vertical-align: middle;">
                    ...
                    <img src="{{ url('storage/upload/dokumen_invoice/' . $data->invoice->foto_invoice) }}" alt="Bukti Foto" width="200px">
