    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        ...
        <div>
            <div class="my-5">
                ...
                <a href="{{route('export-bahan-baku-stok-global', ['tanggal' => $tgl_stok_global, 'id_satuan' => $selectedUnit])}}">
            ...
            <div class="max-w-full overflow-x-auto rounded-t-md">
                @include('pages.dashboard.monitoring_persediaan.bahan_baku.global.export.preview')
            </div>
