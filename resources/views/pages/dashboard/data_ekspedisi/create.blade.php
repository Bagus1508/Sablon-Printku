<div wire:ignore.self id="modal-create-ekspedisi"
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div
                    ...
                    <div>
                        <button data-hs-overlay="#modal-create-ekspedisi" type="button"
                ...
                <form method="POST" action="{{route('data-ekspedisi.store')}}">
                    @csrf
                    <div class="p-6.5">
