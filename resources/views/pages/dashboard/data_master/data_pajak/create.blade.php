<div wire:ignore.self id="modal-create-pajak"
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div
                    ...
                    <div>
                        <button data-hs-overlay="#modal-create-pajak" type="button"
                ...
                <form method="POST" action="{{route('data-pajak.store')}}">
                    @csrf
                    <div class="py-6.5">
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                ...
                                <input type="number" id="ppn" name="ppn" placeholder="Masukan Nama Pajak"
