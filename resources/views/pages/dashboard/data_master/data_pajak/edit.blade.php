<div wire:ignore.self id="modal-edit-pajak"
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div
                    ...
                    <div>
                        <button data-hs-overlay="#modal-edit-pajak" type="button"
                ...
                <form method="POST" id="form-edit-pajak">
                    @csrf
                    <div class="py-6.5">
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                                    Pajak Penerimaan Negara <span class="text-red-500 text-[10px]">*(Wajib diisi)</span>
                                </label>
                                <input type="text" id="ppn" name="ppn" placeholder="Masukan Nama Pajak"
...
<script>
    ...
    const url = '{{ route("data-pajak.update", ":id") }}'.replace(':id', id);
    $('#form-edit-pajak').attr('action', url);
});
