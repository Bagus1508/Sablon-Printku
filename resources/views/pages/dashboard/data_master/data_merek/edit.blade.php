<div wire:ignore.self id="modal-edit-merek"
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                <div
                    ...
                    <div>
                        <button data-hs-overlay="#modal-edit-merek" type="button"
                ...
                <form method="POST" action="{{route('data-merek.update', (int)$ID)}}" id="form-edit-merek">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="py-6.5">
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                                    Kode Merek <span class="text-red-500 text-[10px]">*(Wajib diisi)</span>
                                </label>
                                <input type="text" id="kode_merek" name="kode_merek" placeholder="Masukan Kode Merek"
                        ...
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                                    Nama Merek <span class="text-red-500 text-[10px]">*(Wajib diisi)</span>
                                </label>
                                <input type="text" id="nama_merek" name="nama_merek" placeholder="Masukan Nama Merek"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            </div>
                        </div>
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                ...
                                <select required name="id_kategori" id="id_kategori" class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary">
...
<script>
    ...
    $('.edit-merek').click(function() {
    const id = $(this).data('id-merek');
    const kode_merek = $(this).data('kode-merek');
    const nama_merek = $(this).data('nama-merek');
    const id_kategori = $(this).data('id-kategori');
    
    // Mengatur nilai input ID pada form modal
    $('#kode_merek').val(kode_merek);
    ...
    const url = '{{ route("data-merek.update", ":id") }}'.replace(':id', id);
    $('#form-edit-merek').attr('action', url);
});
