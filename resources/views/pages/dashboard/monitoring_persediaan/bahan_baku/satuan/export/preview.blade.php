...
<table class="w-full table-auto mt-20">
    <thead>
        <tr class="text-left dark:bg-meta-4">
            ...
            <th colspan="{{$jumlahHari}}" class="px-4 py-4 text-center font-medium text-white dark:text-white" style="background-color: #4c1030; color: white; text-align: center; vertical-align: middle; font-weight: bold; border: 1px solid black;" width="150px">
                Tanggal
            </th>
        </tr>
        <tr>
            @foreach ($dateRange as $item)                        
            <th colspan="1" class="dark:text-white dark:bg-meta-4"  style="background-color: #4c1030; color: white; text-align: center; vertical-align: middle; border: 1px solid black;" width="150px">
                {{$item}}{{-- //tanggalnya --}}
            </th>
            @endforeach
        </tr>
