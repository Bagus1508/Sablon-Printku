        ...
        @foreach ($data as $item)                    
            ...
            @endforeach
                <td class="" style="color: #000000; text-align: left; border: 1px solid black;">
                    <p class="dark:text-white">{{ $totalStokMasuk[$item->id] ?? 0 }} {{$satuanNamaTotal}}</p>
                </td>
                <td class="" style="color: #000000; text-align: left; border: 1px solid black;">
                    <p class="dark:text-white">{{ $totalStokKeluar[$item->id] ?? 0 }} {{$satuanNamaTotal}}</p>
                </td>
                <td class="" style="background-color: #FF0000; color: white; text-align: left; border: 1px solid black;">
                    <p class="dark:text-white">{{ $totalStokMasuk[$item->id] - $totalStokKeluar[$item->id] }} {{$satuanNamaTotal}}</p>
                </td>
            </tr>
        @endforeach
    </tbody>
