    ...
    <thead class="bg-blue-600 text-white">
        <tr>
            @php
                $currentYear = date('Y');
            @endphp
            <th colspan="7" rowspan="2" style="background: #FFFF00; font-size: 20px; color: black; text-align: center; font-weight: bold;" class="py-[20px] dark:bg-meta-4">PERSEDIAAN KAIN {{$currentYear}}</th>
        </tr>
        <tr></tr>
        <tr class="dark:bg-meta-4">
            <th class="min-w-[50px] font-medium dark:text-white" style="text-align: center; color:#FFFFFF; background: #ff0000;">
                No
            </th>
            <th class="font-medium dark:text-white" style="text-align: left; color:#FFFFFF; background: #ff0000;" width="150px">
                NO ID
            </th>
            <th class="font-medium dark:text-white" style="text-align: left; color:#FFFFFF; background: #ff0000;"  width="150px">
                Nama Barang
