    ...
    <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            <h2 class="text-title-md2 font-bold text-black dark:text-white">
                Data Pakaian dan Celana Global Export
            </h2>
        </div>
        <div>
            <div class="my-5">
                <div>
                    ...
                    <a href="{{route('export-pakaian-celana-stok-global', ['tanggal' => $tgl_stok_global])}}">
            ...
            <div class="max-w-full overflow-x-auto rounded-t-md">
                @include('pages.dashboard.monitoring_persediaan.pakaian_celana.global.export.preview_export')
            </div>
