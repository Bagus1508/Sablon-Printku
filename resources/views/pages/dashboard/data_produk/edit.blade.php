    ...
    <div
        ...
        <div class="p-4 sm:p-7">
            <div class="rounded-md border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <form method="POST" action="{{route('data-produk.update', (int)$ID)}}" id="form-edit-produk">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="py-6.5">
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                                    Kode Produk <span class="text-red-500 text-[10px]">*(Wajib diisi)</span>
                                </label>
                                <input type="text" id="kode_merek" name="kode_merek" placeholder="Masukan Kode Produk"
                        ...
                        <div class="px-6.5">
                            <div class="mb-4.5 w-full">
                                <label class="mb-3 block text-sm font-medium text-black dark:text-white">
                                    Nama Produk <span class="text-red-500 text-[10px]">*(Wajib diisi)</span>
                                </label>
                                <input type="text" id="nama_merek" name="nama_merek" placeholder="Masukan Nama Produk"
                                    class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary" />
                            </div>
                        </div>
                        <div class="px-6.5">
...
<script>
    ...
    const id = $(this).data('id-produk');
    const kode_merek = $(this).data('kode-produk');
    const nama_merek = $(this).data('nama-produk');
    ...
    const url = '{{ route("data-produk.update", ":id") }}'.replace(':id', id);
    $('#form-edit-produk').attr('action', url);
});
