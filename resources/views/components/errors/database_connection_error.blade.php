...
<head>
    ...
    @vite(['resources/css/landing.min.css'])
</head>
<body class="antialiased">
    <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-48 lg:px-8">
        <div class="text-center">
          <p class="text-base font-semibold text-indigo-600">Error Code 500</p>
          <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Internal Sever Error!</h1>
          <p class="mt-6 text-base leading-7 text-gray-600">Error Establishing a Database Connection.</p>
