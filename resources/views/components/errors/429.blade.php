<x-app-layout background="bg-white">
    <main class="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-48 lg:px-8">
        <div class="text-center">
          <p class="text-base font-semibold text-indigo-600">Error Code 429</p>
          <h1 class="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">Too Many Requests!</h1>
