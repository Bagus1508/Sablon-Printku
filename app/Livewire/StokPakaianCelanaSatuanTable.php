...
class StokPakaianCelanaSatuanTable extends Component
{
    use WithPagination;

    public $search = "";
    public $perPage = 10;
    public $filter, $tanggal, $ID, $Id_stok, $Id_produk, $Id_no, $Nama_barang, $Warna, $Kode_warna, $Id_satuan, $Id_ukuran, $Tanggal_stok, $Stok_masuk, $Stok_keluar;
    public $DataStok;
    public $startDate;
    public $endDate;
    ...
    public function mount()
    {
        ...
        $this->ID = request()->query('stok_pakaian_celana');
    ...
    public function render()
    {
        ...
        return view('livewire.stok-pakaian-celana-satuan-table', [
            'dataStok' => $Data,
            'nodata' => $datanotfound,
