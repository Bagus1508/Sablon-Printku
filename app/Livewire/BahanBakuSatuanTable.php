...
class BahanBakuSatuanTable extends Component
{
    use WithPagination;
    public $search = "";
    public $perPage = 10;
    ...
    {
        return redirect()->to("stok-bahan-baku-satuan?stok_bahan=$id");
    }
    ...
    public function editBahanBaku(int $id){
        $this->ID = $id;
    ...
    public function render()
    {
        ...
        return view('livewire.bahan-baku-satuan-table', [
            'data' => $data,
            'nodata' => $datanotfound,
